...
function CompaniaSearch () {     
 ...
 const submitHandle = event => {       
    ...
    dispatch(crudActions.searchList('COMPANIAS_DATA','companias',item))  
  ...
  return (    
      <div className="herramientas">          
           <div className="caja">
                <Row>
                  <Col md="10" className="cajas text-white">Lista de Companias</Col>
                </Row>                                
           </div>
