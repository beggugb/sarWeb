...
function CotizacionSearch () {     
 ...
 const submitHandle = event => {       
    ...
    dispatch(crudActions.searchList('COTIZACIONES_DATA','cotizaciones',item))  
  ...
  return (    
      <div className="herramientas">          
           <div className="caja">
                <Row>
                  <Col md="10" className="cajas text-white">Lista de Cotizacions</Col>
                </Row>                                
           </div>
...
export default CotizacionSearch