...
function PolizasSearch () {     
 ...
 const submitHandle = event => {       
    ...
    dispatch(crudActions.searchList('POLIZAS_DATA','polizas',item))  
  ...
  return (    
      <div className="herramientas">          
           <div className="caja">
                <Row>
                  <Col md="10" className="cajas text-white">Lista de Polizas</Col>
                </Row>                                
           </div>
